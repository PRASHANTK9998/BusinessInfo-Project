...
namespace BusinessInfoApiProject.HelperClass
{
    public class JwtTokenHelper
    {
        ...
        public JwtTokenHelper(IConfiguration configuration, UserManager<ApplicationUser> userManager, BusinessDbContext context)
        {
